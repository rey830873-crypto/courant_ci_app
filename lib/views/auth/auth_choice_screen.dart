        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Crée un compte pour activer les alertes personnalisées et '
                'sauvegarder ton profil, ou continue en invité.',
              ...
              Text(
                'En mode invité, certaines fonctionnalités (recharge, '
                'historique) seront limitées. Tu pourras créer un compte '
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'Firebase n\'est pas encore configuré : seul le '
                          'mode invité est disponible pour le moment.',
